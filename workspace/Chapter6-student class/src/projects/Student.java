...
public class Student {
   ...
   public String validateData() {
	...
	if (!(test1 <=100) || !(test1 >=0)) {
		result = "Error, test 1 is not within valid range 0-100";
	}
	if (!(test2 <=100) || !(test2 >=0)) {
		result = "Error, test 2 is not within valid range 0-100";
	}
	if (!(test3 <=100) || !(test3 >=0)) {
		result = "Error, test 3 is not within valid range 0-100";
	}
	return result;
}
}
