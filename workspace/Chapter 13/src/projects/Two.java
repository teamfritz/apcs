...
public static void main(String[] args) {
		ezprint(reverse("looc ,sdrawkcab si siht", 0));
	}
	
	public static String reverse(String start, int pos) {
		if(pos + 1 > start.length())
			return "";
		String newletter = Character.toString(start.charAt(start.length()-(pos+1)));
		String current = newletter + reverse(start, pos+1);
		return current;
	}
